...
import libsearcher.mepride.android.librarysearcher.widget.layoutmanager.BannerLayoutManager;
import libsearcher.mepride.android.librarysearcher.widget.layoutmanager.CenterSnapHelper;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs) {
        ...
        params.gravity = Gravity.BOTTOM|Gravity.CENTER_HORIZONTAL | gravity;
